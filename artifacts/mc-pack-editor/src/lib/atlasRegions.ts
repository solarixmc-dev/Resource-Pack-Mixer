...
export const ATLAS_DEFINITIONS: AtlasDefinition[] = [
  {
    ...
    regions: [
      ...
      { id: "xp_bar_empty", label: "XP Bar (Empty)", x: 0, y: 64, w: 182, h: 5, description: "Experience bar empty segment" },
      { id: "xp_bar_full", label: "XP Bar (Full)", x: 0, y: 69, w: 182, h: 5, description: "Experience bar filled segment" },
    ],
  },
  {
    ...
    label: "Widget Atlas",
    regions: [
      { id: "hotbar_container", label: "Hotbar Container", x: 0, y: 0, w: 182, h: 22, description: "Hotbar background" },
      { id: "active_selector", label: "Active Selector", x: 0, y: 22, w: 24, h: 24, description: "Selected hotbar slot highlight" },
      { id: "button_disabled", label: "Button (Disabled)", x: 0, y: 46, w: 200, h: 20, description: "Disabled button sprite" },
      { id: "button_normal", label: "Button (Normal)", x: 0, y: 66, w: 200, h: 20, description: "Normal button sprite" },
      { id: "button_hover", label: "Button (Hover)", x: 0, y: 86, w: 200, h: 20, description: "Hover button sprite" },
    ],
  },
];
